    ...
    octokit.rest.actions.getWorkflowRun.mockReturnValue(
      Promise.resolve({
        data: {
          ...
          referenced_workflows: [
            {
              path: "step-security/slsa-github-generator/.github/workflows/builder_docker-based_slsa3.yml@9929152897cce5842f58221572911e18dd937808",
          ...
          repository: {
            ...
            full_name: "step-security/slsa-github-generator",
          },
          head_repository: {
            name: "slsa-github-generator",
